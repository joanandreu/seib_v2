...
use App\DataTables\Backend\TipoEntidadDataTable;
...
class TipoEntidadController extends AppBaseController
{
     ...
     *
     * @param TipoEntidadDataTable $tipoEntidadDataTable
     * @return Response
     */
    public function index(TipoEntidadDataTable $tipoEntidadDataTable)
    {
        return $tipoEntidadDataTable->render('backend.tipo_entidads.index');
    }
